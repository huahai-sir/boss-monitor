...
FIXED_EVENTS = [
    ...
    {"name": "异教徒地下墓穴（个人战）", "days": [0,2,4], "hour": 12, "minute": 5},
    {"name": "异教徒地下墓穴（个人战）", "days": [0,2,4], "hour": 20, "minute": 35},
    {"name": "异教徒地下墓穴（战盟战）", "days": [5,6], "hour": 20, "minute": 35},
    {"name": "异教徒地下墓穴（战盟战）", "days": [5,6], "hour": 21, "minute": 5},
